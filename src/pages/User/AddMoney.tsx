...
import { useAddMoneyMutation } from "@/redux/Wallet/wallet.api";
...
const AddMoney = () => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    try {
      ...
      if (res.success) {
        setSuccessMessage(res.message || "Money added successfully!");
        form.reset();
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="bg-card rounded-lg shadow-lg border p-8 mb-6">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Transfer funds from your wallet to your bank account</p>
          </div>
        ...
        <div className="bg-card rounded-lg shadow-md border p-6">
          <h3 className="font-semibold text-foreground mb-3">Deposit Information</h3>
          <ul className="text-sm text-muted-foreground space-y-2">
            ...
            <li className="flex items-center gap-2">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
              Minimum deposit amount is  ৳ 0.01
            </li>
            <li className="flex items-center gap-2">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
              Funds will be deducted from to your linked  account
            </li>
          </ul>
        </div>
      </div>
