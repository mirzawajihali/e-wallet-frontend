...
import { AlertCircle, CheckCircle2, Minus, CreditCard } from "lucide-react";
import { useState } from "react";
import { useWithdrawMutation } from "@/redux/Wallet/wallet.api";
...
const Withdraw = () => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    try {
      const res = await withdraw(withdrawData).unwrap();
      if (res.success) {
        setSuccessMessage(res.message || "Money withdrawn successfully!");
        form.reset();
